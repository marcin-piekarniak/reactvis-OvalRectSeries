declare module 'react-vis' {
  ...
  export class AbstractSeries<T> extends PureComponent<T> {
    _getAttributeFunctor: Function;
    _getAttr0Functor: Function;
    _valueClickHandler: Function;
    _valueRightClickHandler: Function;
    _valueMouseOverHandler: Function;
    _valueMouseOutHandler: Function;
  }
  ...
  export interface LabelSeriesProps extends AbstractSeriesProps<LabelSeriesPoint> {
    ...
    labelAnchorY?: string;
    className?: string;
    getLabel?: RVGet<LabelSeriesPoint, 'label'>;
  }
